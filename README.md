...
<img src="https://github.com/user-attachments/assets/76906dbc-343d-4267-ace5-048d428fff42" width="20px"> CraftMyCv is your all-in-one tool to analyze, optimize, and craft resumes that stand out, helping you land your dream job.  
</div>
...
<table align="center">
    ...
    <tbody>
         <tr>
            ...
            <td><img alt="Open PRs" src="https://img.shields.io/github/issues-pr/TeamCompileError/CraftMyCv?style=flat&logo=github"/></td>
            <td><img alt="Closed PRs" src="https://img.shields.io/github/issues-pr-closed/TeamCompileError/CraftMyCv?style=flat&color=critical&logo=github"/></td>
...
- [![Streamlit Badge](https://img.shields.io/badge/Live%20Demo-Streamlit-orange?style=for-the-badge&logo=streamlit&logoColor=white)](https://craftmycv.streamlit.app/)  

- [![Documentation Badge](https://img.shields.io/badge/Documentation-Request-blue?style=for-the-badge&logo=gmail&logoColor=white)](mailto:priyanshusrivastava514@gmail.com?subject=Request%20Documentation%20for%20CraftMyCv&body=Hi%20Team%20Compile%20Error,%0D%0AI%20am%20interested%20in%20learning%20more%20about%20your%20project,%20CraftMyCv.%20Here%20are%20my%20details:%0D%0A%0D%0AName:%0D%0AOrganization/College:%0D%0APurpose%20of%20request:%0D%0A%0D%0AThanks!)  
...
- [![Contribution Guide Badge](https://img.shields.io/badge/Contribution%20Guide-Read%20Here-brightgreen?style=for-the-badge&logo=github&logoColor=white)](https://github.com/TeamCompileError/CraftMyCv/blob/main/.github/CONTRIBUTING.md)   

- [![Support Badge](https://img.shields.io/badge/Support%20%26%20Feedback-Discussion-ff69b4?style=for-the-badge&logo=github&logoColor=white)](https://github.com/TeamCompileError/CraftMyCv/discussions)  
...
👨‍💻 Try it Now: [![Open in Streamlit](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://craftmycv.streamlit.app/)  
...
Follow these steps to run CraftMyCv:  

#### **Setup Instructions** 🛠️

Follow the steps below to set up and run **CraftMyCv** on your local machine.
...
Open a terminal and run:
   ...
   ```bash
   git clone https://github.com/TeamCompileError/CraftMyCv.git
   cd CraftMyCv
   ```
...
### What's Happening? 🤔  
If you're using the **Browser's (e.g., Chrome, Edge, etc.) Autofill** feature to quickly fill out your **Name**, **Email**, and **Phone** details in our **CraftMyCv**, you might encounter this error in generating Resume:  
...
##  <img src="https://github.com/user-attachments/assets/5b3cb883-6652-4525-a352-b4b9a3501e07" width = 35px height = 35px> **Why Users Love CraftMyCv**  
...
Explore the code, contribute, or drop a <img src="https://github.com/user-attachments/assets/35f6838c-52f5-4e48-8a98-c5203f8c57e3" style="width:20px; color: #FFD700" alt="Star GIF"> : [CraftMyCv Repository](https://github.com/priyanshu-0212)
