...
class ResumeApp:
    ...
    def load_lottie_url(self, url: str):
        ...
        try:
            ...
            # This is not recommended for production but helps bypass SSL issues
    ...
    def apply_global_styles(self):
        ...
        /* Make sure main content area is also black */
        ...
        /* Enhanced Sidebar Styling - Using multiple selectors to ensure compatibility */
        ...
        [data-testid="stSidebar"] h1 {
            ...
            text-shadow: 0 2px 10px rgba(108, 99, 255, 0.3) !important;
            padding: 0.5rem !important;
            font-size: 28px !important;
        }

        /* Add a cool underline to the title */
        [data-testid="stSidebarNav"] h1:after, 
        .css-10trblm:after,
        ...
        [data-testid="stSidebarNav"] button:nth-child(1) { animation-delay: 0.1s !important; }
        [data-testid="stSidebarNav"] button:nth-child(2) { animation-delay: 0.2s !important; }
        [data-testid="stSidebarNav"] button:nth-child(3) { animation-delay: 0.3s !important; }
        [data-testid="stSidebarNav"] button:nth-child(4) { animation-delay: 0.4s !important; }
        [data-testid="stSidebarNav"] button:nth-child(5) { animation-delay: 0.5s !important; }
        [data-testid="stSidebarNav"] button:nth-child(6) { animation-delay: 0.6s !important; }
        [data-testid="stSidebarNav"] button:nth-child(7) { animation-delay: 0.7s !important; }
        ...
        [data-testid="baseButton-secondary"][aria-selected="true"],
        .st-emotion-cache-7ym5gk[aria-selected="true"],
        [data-testid="stSidebarNav"] button[aria-selected="true"],
        .stButton > button[aria-selected="true"] {
            background: linear-gradient(90deg, rgba(108, 99, 255, 0.2), rgba(33, 212, 253, 0.1)) !important;
            border-left: 4px solid var(--primary-color) !important;
            color: white !important;
            font-weight: 600 !important;
            box-shadow: 0 5px 15px rgba(108, 99, 255, 0.15) !important;
        }

        /* Emoji icons in buttons */
        [data-testid="stSidebarNav"] button span:first-child,
        ...
        /* Hover effect for emoji icons */
        [data-testid="stSidebarNav"] button:hover span:first-child,
        .stButton > button:hover span:first-child {
            transform: scale(1.2) rotate(5deg) !important;
            color: var(--accent-color) !important;
            text-shadow: 0 0 10px rgba(33, 212, 253, 0.5) !important;
        }
        ...
        [data-testid="stSidebarNav"] button:hover::after,
        ...
        .css-163ttbj::after,
        .css-1siy2j7::after {
            content: '© 2025 CraftMyCv' !important;
            display: block !important;
            position: absolute !important;
        ...
        /* Animations */
        @keyframes shimmer {
            0% { background-position: -100% 0 !important; }
            100% { background-position: 200% 0 !important; }
        }

        /* Ensure white text in sidebar */
        ...
        @keyframes headerGlow {
            from { box-shadow: 0 10px 30px rgba(108, 99, 255, 0.2); }
            to { box-shadow: 0 10px 30px rgba(108, 99, 255, 0.5); }
        }
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            # Removed the "Star this repo" section as requested.
            
            # Footer text
            st.markdown("""
            <p style='text-align: center;'>
                Powered by <b>Streamlit</b> and <b>Google Gemini AI</b> | Developed by 
                <a href="mailto:sangamparmar94@gmail.com" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Team Compile Error</b>
                </a>
            </p>
    ...
    def load_image(self, image_name):
        ...
        try:
            image_path = f"c:/Users/shree/Downloads/craftmycv/{image_name}"
    ...
    "assets",
     "124852522.jpeg")
        ...
        st.markdown("""
            ...
            <h1 class="hero-title">About CraftMyCv</h1>
        ...
        st.markdown(f"""
            ...
            <img src="{image_base64 if image_base64 else 'https://avatars.githubusercontent.com/Hunterdii'}"
             alt="Compile Error Team"
             class="profile-image"
             onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/Hunterdii';">
            <h2 class="profile-name">Team Compile Error</h2>
            <p class="profile-title">Innovators in AI and Resume Optimization</p>
            <p class="bio-text">
            We are Team Compile Error, a group of passionate developers and AI enthusiasts dedicated to transforming the way job seekers approach their career journey. 
            Our team members include:
            </p>
            <ul class="bio-text">
            <li><span style="font-size: 1.2rem; font-weight: bold; color: #4CAF50;">Ayush Keshari</span> 
                <a href="https://www.linkedin.com/in/ayush--keshari/" class="social-link" target="_blank" style="margin-left: 10px; color: #0077b5;">
                <i class="fab fa-linkedin"></i>
                </a>
            </li>
            <li><span style="font-size: 1.2rem; font-weight: bold; color: #4CAF50;">Sangam Parmar</span> 
                <a href="https://www.linkedin.com/in/sangam-parmar/" class="social-link" target="_blank" style="margin-left: 10px; color: #0077b5;">
                <i class="fab fa-linkedin"></i>
                </a>
            </li>
            <li><span style="font-size: 1.2rem; font-weight: bold; color: #4CAF50;">Priyanshu Srivastava</span> 
                <a href="https://www.linkedin.com/in/priyanshu-srivastava-380422252/" class="social-link" target="_blank" style="margin-left: 10px; color: #0077b5;">
                <i class="fab fa-linkedin"></i>
                </a>
            </li>
            <li><span style="font-size: 1.2rem; font-weight: bold; color: #4CAF50;">Shivraj Singh Chundawat</span> 
                <a href="https://www.linkedin.com/in/shivraj-singh-chundawat/" class="social-link" target="_blank" style="margin-left: 10px; color: #0077b5;">
                <i class="fab fa-linkedin"></i>
                </a>
            </li>
            </ul>
            <p class="bio-text">
            Together, we have combined our expertise in software development, AI, and machine learning to create CraftMyCv, a platform designed to provide intelligent, data-driven insights for resume optimization.
            </p>
            </div>
        """, unsafe_allow_html=True)
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "CraftMyCv represents my vision of democratizing career advancement through technology.
    ...
    text="Number of Resumes", font=dict(
        size=16, color="white")),
            ...
            uploaded_file = st.file_uploader(
                "Upload your resume", type=['pdf', 'docx'], key="ai_file")
    ...
    def main(self):
        ...
        with st.sidebar:
            ...
            animation_data = self.load_lottie_url(lottie_url)
            
            if animation_data:
                st_lottie(animation_data, height=200, key="sidebar_animation")
            else:
                # Provide a simple placeholder when animation fails to load
